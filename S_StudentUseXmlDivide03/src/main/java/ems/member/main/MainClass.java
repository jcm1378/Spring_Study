...
public class MainClass { //xml컨테이너를 사용하는 방법.
	...
	public static void main(String[] args) {
		...
		//방법 1 분할시킨 appcontext중 사용하고자 하는 컨테이너를 배열 형태로 저장해 컨테이너 생성시 파라미터안에 배열들을 집어넣어 사용
		...
		GenericXmlApplicationContext ctx = new GenericXmlApplicationContext(appContext);
		 ...
		 /*방법2 분할시킨 appcontext들을 하나의 xml파일에 import해서 사용 하지만 1번을 주로 사용함 
		
		GenericXmlApplicationContext impctx = 
		  	new GenericXmlApplicationContext("classpath:appImport.xml");
		  */
